                                    ...
                                    <tr class="cart_table_item">
                                        <td class="product-thumbnail">
                                            <div class="product-thumbnail-wrapper">
                                                <a href="{{route('delete',$itemCart)}}" class="product-thumbnail-remove" title="Remove Product">
                                                    <i class="fas fa-times"></i>
                                                </a>
                                                <a href="{{route('welcome.detail',$itemCart)}}" class="product-thumbnail-image" title="Photo Camera">
                                                    <img width="90" height="90" alt="" class="img-fluid" src="{{Storage::url($itemCart->product->image)}}">
                                                </a>
                                            </div>
                                        </td>
                                        <td class="product-name">
                                            <a href="{{route('welcome.detail',$itemCart)}}" class="font-weight-semi-bold text-color-dark text-color-hover-primary text-decoration-none">{{$itemCart->product->name}}</a>
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity float-none m-0">
                                                ...
                                                <input type="text" class="input-text qty text" title="Qty" id="{{$itemCart->product_id}}" value="{{$itemCart->quantite}}" name="quantity" min="1" step="1">
                                        ...
                                        <td class="product-subtotal text-end">
                                            <span class="amount text-color-dark font-weight-bold text-4">{{$itemCart->price * $itemCart->quantite}}€</span>
                                        </td>
                                    </tr>
                                    @endforeach
                                ...
                                <tbody>
                                    <tr class="cart-subtotal">
                                        ...
                                        <td class="border-top-0 text-end">
                                            <strong><span class="amount font-weight-medium">{{$somme}}€</span></strong>
                                        </td>
                                    </tr>
                                    <tr class="shipping">
                                        <td colspan="2">
