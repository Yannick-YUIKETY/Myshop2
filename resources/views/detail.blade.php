        ...
        <div class="row">
            <div class="col">
                <ul class="breadcrumb breadcrumb-style-2 d-block text-4 mb-4">
                    <li><a href="{{route('welcome')}}" class="text-color-default text-color-hover-primary text-decoration-none">Home</a></li>
                    <li><a href="{{route('welcome.categorie',$product->categorie_id)}}" class="text-color-default text-color-hover-primary text-decoration-none">{{$product->categorie->name}}</a></li>
                    <li>{{$product->name}}</li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-5 mb-5 mb-md-0">
                ...
                <div class="thumb-gallery-wrapper">
                    <div class="manual nav-inside nav-style-1 nav-dark mb-3">
                        <div>
                            <img alt="" class="img-fluid" src="{{Storage::url($product->image)}}" data-zoom-image="">
                        </div>
            ...
            <div class="col-md-7">
                ...
                <div class="summary entry-summary position-relative">
                    ...
                    <form enctype="multipart/form-data" method="post" class="cart" action="shop-cart.html">
                        ...
                        <a href="{{route('addtocart',$product->id)}}" type="submit" class="btn btn-dark btn-modern text-uppercase bg-color-hover-primary border-color-hover-primary">Add to cart</a>
                        <hr>
                    </form>
